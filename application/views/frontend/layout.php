...
<html>
<head>
	<title>SPP | Cek Tagihan Santri</title>
	<meta charset="utf-8">
...
<body>
	<nav class="navbar navbar-default fixed">
		<div class="navbar-header"> 
			<a class="navbar-brand" href=""> ADMINISTRASI PONPES
				...
				<?php } else { ?>
				<img src="<?php echo media_url('img/logo.png') ?>" style="height: 40px; margin-top: -10px; margin-right: 5px;" class="pull-left">
